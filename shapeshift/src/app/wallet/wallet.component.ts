...
import {
  getBTCBalance, getBtcLoading, getETHBalance, getEthLoading, getREPBalance, getTokenBalanceAragon,
  getTokenBalanceAugur, getTokenBalanceBat, getTokenBalanceEos, getTokenBalanceGnosis, getTokenBalanceGolem,
  getTokenBalanceSalt, getTokenLoadingAragon,
  getTokenLoadingAugur, getTokenLoadingBat, getTokenLoadingEos, getTokenLoadingGnosis,
  getTokenLoadingGolem, getTokenLoadingSalt,
...
export class WalletComponent implements OnInit {
  ...
  constructor(private store: Store<AppState>) {
    ...
    this.wallets = [
      ...
      { id: 6, icon: 'assets/icon/gno-icon-o.png', name: 'GNO', fullName: 'Gnosis', $balance: this.$tokenBalanceGnosis, usd: 0, $loading: this.$tokenGnosisLoading },
      { id: 7, icon: 'assets/icon/bat-icon-o.png', name: 'BAT', fullName: 'BAT', $balance: this.$tokenBalanceBat, usd: 0, $loading: this.$tokenBatLoading },
      { id: 8, icon: 'assets/icon/ant-icon-o.png', name: 'ANT', fullName: 'Aragon', $balance: this.$tokenBalanceAragon, usd: 0, $loading: this.$tokenAragonLoading },
      { id: 9, icon: 'assets/icon/eos-icon-o.png', name: 'EOS', fullName: 'EOS', $balance: this.$tokenBalanceEos, usd: 0, $loading: this.$tokenEosLoading },
      { id: 10, icon: 'assets/icon/salt-icon-o.png', name: 'SALT', fullName: 'SALT', $balance: this.$tokenBalanceSalt, usd: 0, $loading: this.$tokenSaltLoading },
    ];
  }
